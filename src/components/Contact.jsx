      ...
      <div className="contact-div1">
        <div className="contact-div2">
          ...
          <p className="contact-p">
            If you are looking for a developer to meet the needs of your
            projects, you are with the right person!. Send me an email or a
            message so we can get in touch.
          </p>
        </div>
